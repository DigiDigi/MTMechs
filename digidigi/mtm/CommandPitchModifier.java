...
public class CommandPitchModifier extends CommandBase implements ICommand
{
    ...
    public void processCommand(ICommandSender icommandsender, String[] astring)
    {
        ...
        {
            Debug.serverMessage("beamPitchModifier == " + RenderFireBeam.beamPitchModifier);
        }
    ...
    public void sendToClients(float param, float param2)
    {
        ...
        Debug.serverMessage("beamPitchModifier = " + param);
    }
