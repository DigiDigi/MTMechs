...
public class RenderTA extends RenderLiving
{
	private ModelTA model;
	public boolean Empty = false; // Keeping track of whether the mech has magic slotted or not.

	public RenderTA(ModelTA modelpa, float f)
	{
        super(new ModelTA(), f);
        this.model = (ModelTA)super.mainModel;
        this.setRenderPassModel(this.model);
	}
	
	public void renderMT(EntityTA entitypa, double par2, double par4, double par6, float par8, float par9)
	{   
	...
	{
	    this.renderMT((EntityTA)entityliving, par2, par4, par6, par8, par9);
	}
	
	public void doRender(Entity entity, double par2, double par4, double par6, float par8, float par9)
	{
	    this.renderMT((EntityTA)entity, par2, par4, par6, par8, par9);
    ...
    protected int coreGlow(EntityTA entity, int par2, float par3)
    {
        if (par2 != 0)
        {
            return -1;
        ...
        else
        {
            if (this.Empty)
            {
                this.bindTexture(Textures.TACoreEmpty);
            }
            else
            {
                this.bindTexture(Textures.TACore);
            }
    ...
    protected void scaleMT(EntityTA entity, float par2)
    {
    ...
    {
        this.scaleMT((EntityTA)entity, par2);
    }

    protected int shouldRenderPass(EntityLivingBase entity, int par2, float par3)
    {
        return this.coreGlow((EntityTA)entity, par2, par3);
    }
